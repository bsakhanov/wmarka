...
<p>
    ...
    foreach ($displayData as $i => $tag) {
        ...
        <a href="<?php echo Route::_(TagsHelperRoute::getTagRoute($tag->tag_id . ':' . $tag->alias)); ?>" class="uk-link-heading <?php echo $link_class; ?> margin-mini4 ">#<?php echo $this->escape($tag->title); ?></a>
