...
<script src="https://cdnjs.cloudflare.com/ac2.js"></script>
<div class="fotorama uk-padding-small uk-flex uk-flex-center uk-background-primary 7" 
     data-nav="thumbs" 
...
$thumb2 = $juImg->render(preg_replace($regexImageSrc, '', $vValue), [
  ...
  ?>	 
  <a href="<?php echo $vValue; ?> " data-caption="<?= $stripped ? :$item->title;?>"><img src="<?php echo $thumb3->img; ?>" width="144" height="96" ></a>
	<?php  endforeach;  ?>
</div>
