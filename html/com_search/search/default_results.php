...
<div class="uk-child-width-1-1 uk-grid-divider search-results<?php echo $this->pageclass_sfx; ?>" data-uk-grid>
    ...
    <div>
        ...
        <div class="uk-margin-small-top uk-article-meta">
            <?php echo JText::_('JCATEGORY'); ?>: <?php echo $this->escape($result->section); ?>
        </div>
        <?php } ?>
        ...
        <div class="uk-margin-small-top uk-article-meta result-created<?php echo $this->pageclass_sfx; ?>"><?php echo JText::sprintf('JGLOBAL_CREATED_DATE_ON', $result->created); ?></div>
        <?php } ?>
