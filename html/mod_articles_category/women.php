		...
		<div class="uk-width-2-3@m">
			...
			<!-- Latest article -->
				...
				<div class="uk-inline uk-margin">
						...
						<img class="uk-border-rounded" src="<?php echo $thumb->webp; ?>" type="image/webp" width="600" height="338" alt="<?php echo $article_image_alt[$list[0]->id]; ?>"  itemprop="thumbnailUrl"/>
				...
				<div class="news-data d-flex justify-content-between">					
					<h3 class="uk-h4 uk-margin-remove uk-link-heading">
			...
			<div class="uk-flex-middle uk-grid-small margin-mini3" uk-grid>					
					...
					<div class="uk-width-1-3 uk-inline ">
						...
						<div class="view overlay  shadow mb-md-0 mb-4">
								...
								<img class="uk-border-rounded" src="<?php echo $thumb1->webp; ?>" type="image/webp" width="120" height="90" alt="<?php echo $article_image_alt[$list[1]->id]; ?>"  itemprop="thumbnailUrl"/>
			...
			<div class="uk-flex-middle uk-grid-small margin-mini3" uk-grid>					
					...
					<div class="uk-width-1-3 uk-inline ">
						...
						<div class="view overlay  shadow mb-md-0 mb-4">
								...
								<img class="uk-border-rounded"  src="<?php echo $thumb2->webp; ?>" type="image/webp" width="120" height="90" alt="<?php echo $article_image_alt[$list[2]->id]; ?>"  itemprop="thumbnailUrl"/>
			...
			<div class="uk-flex-middle uk-grid-small margin-mini3" uk-grid>					
					...
					<div class="uk-width-1-3 uk-inline ">
						...
						<div class="view overlay  shadow mb-md-0 mb-4">
								...
								<img class="uk-border-rounded" src="<?php echo $thumb3->webp; ?>" type="image/webp" width="120" height="90" alt="<?php echo $article_image_alt[$list[3]->id]; ?>"  itemprop="thumbnailUrl"/>
			...
			<div class="uk-flex-middle uk-grid-small margin-mini3" uk-grid>					
					...
					<div class="uk-width-1-3 uk-inline ">
						...
						<div class="view overlay  shadow mb-md-0 mb-4">
								...
								<img class="uk-border-rounded" src="<?php echo $thumb4->webp; ?>" type="image/webp" width="120" height="90" alt="<?php echo $article_image_alt[$list[4]->id]; ?>"  itemprop="thumbnailUrl"/>
