...
?>
<section class="uk-section uk-section-xsmall uk-padding-remove-vertical">
...
<div class="" >
    <?php if ($grouped) : ?>
        ...
        <li>
            ...
            <ul>
                <?php require ModuleHelper::getLayoutPath('mod_articles_category', $params->get('layout', 'default') . '_stack'); ?>
            </ul>
        </li>
        <?php endforeach; ?>
    <?php else : ?>
