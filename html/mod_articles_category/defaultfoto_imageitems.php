...
<img class="uk-border-rounded" src="<?php echo $thumb->webp; ?>" type="image/webp" width="390" height="260" 
 ...
 <div class="uk-card-body uk-card-small uk-padding-remove-horizontal uk-margin-top">
    <?php if ($params->get('link_titles') == 1) : ?>
        <?php $attributes = ['class' => 'mod-articles-category-title ' . $item->active]; ?>
		<h3 class="news-h6 uk-text-bold uk-card-header uk-padding-remove uk-link-heading">    <?php if ($item->displayDate) : ?>
    ...
    <?php else : ?>
	<div class="uk-h6 uk-text-primary uk-margin-small-bottom uk-link-heading">
        <?php echo $item->title; ?>
		</div>
    <?php endif; ?>
