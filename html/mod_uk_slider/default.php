        ...
        <ul class="uk-slider-items<?php echo $classes; ?>">
            ...
            <li class="" >
                ...
                <div<?php echo $item_class; ?>>
                    ...
                    <?php if ($item->link) { ?>
                    <div class="uk-margin-small-top"><a class="uk-button uk-button-link uk-flex uk-flex-center" href="<?php echo $item->link; ?>" target="_blank"><?php echo $item->link_text; ?></a></div>
                    <?php } ?>
                </div>
            </li>
            <?php } ?>
