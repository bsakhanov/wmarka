...
<div class="uk-card box-shadow-kvadro uk-margin-small uk-border-rounded  uk-padding-remove uk-background-secondary-2" itemscope="itemscope" itemtype="http://schema.org/Person" >
	<a href="#<?php echo $moduleLink; ?>" class="" uk-toggle=""><figure class="thumbnail uk-card-media-top uk-border-rounded uk-inline-clip uk-transition-toggle " itemtype="https://schema.org/ImageObject" itemprop="image"><img src="<?php echo $uploadImage; ?>" alt="<?php echo $titleText; ?>" width="400" height="400" class="uk-transition-scale-up uk-transition-opaque uk-border-rounded" itemprop="url" />
	...
	<div class="uk-card-body uk-border-rounded  uk-background-secondary-2 uk-card-small">
		<div class="uk-card-title" ><a href="#<?php echo $moduleLink; ?>" class="uk-text-primary uk-button uk-button-text3 uk-text-center" uk-toggle=""><?php echo $titleText; ?></a>
		...
		<a href="#<?php echo $moduleLink; ?>" class="uk-button uk-button-uslugi" uk-toggle=""><div class="uk-card-footer uk-text-center" ><?php echo $paragraphText; ?></div></a>
	</div>
</div> 