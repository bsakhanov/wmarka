...
$slideBgColor             = $params->get('slideBgColor');
$slideBgOpacity           = $params->get('slideBgOpacity');
...
<li class=" uk-transition-toggle" tabindex="0" itemscope="itemscope" itemtype="https://schema.org/ImageObject">
 	<a href="#<?php echo $moduleLink; ?>" target="_<?php echo $moduleTarget; ?> " uk-toggle><div class="uk-inline-clip <?php echo $slideBgColor; ?>"   ><img src="<?php echo $uploadImage; ?>" alt="<?php echo $titleText; ?>" width="auto" height="100%" class="uk-inline uk-transition-scale-up uk-transition-opaque uk-brightness3" itemprop="image" contentUrl="url" >            

				</div>  
            </a>
			<div class="uk-position-center" itemscope itemtype="http://schema.org/Service">
                <div class=" <?php echo $titleColor; ?> uk-text-center"><h4 class="uk-margin-remove-right uk-margin-remove-left uk-margin-medium-bottom">
				<a href="#<?php echo $moduleLink; ?>"><span uk-icon="icon: <?php echo $titleIcon; ?>; ratio: 3"></span></a></h4></div>
                <div class="uk-transition-slide-bottom-large uk-text-center <?php echo $titleColor; ?>"><h4 class="uk-margin-remove uk-padding-top"><a href="#<?php echo $moduleLink; ?>" class=" uk-text-center uk-button uk-button-text5 " itemprop="name" uk-toggle=""><?php echo $titleText; ?></a></h4></div>
