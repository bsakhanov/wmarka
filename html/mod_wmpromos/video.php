...
<li class="uk-card  uk-width-medium uk-margin-small uk-border-rounded  uk-padding-remove uk-background-secondary-2 box-shadow-kvadro" itemscope itemtype="http://schema.org/VideoObject"  >

	<a href="//www.youtube.com/watch?v=<?php echo $moduleLink; ?>" data-caption="<?php echo $titleText; ?>" ><figure class="uk-card-media-top uk-border-rounded uk-inline-clip uk-transition-toggle " ><img src="//img.youtube.com/vi/<?php echo $moduleLink; ?>/mqdefault.jpg" alt="<?php echo $titleText; ?>"  width="320" height="180" class="uk-transition-scale-up uk-transition-opaque uk-border-rounded" itemprop="thumbnailUrl"/>
