...
<div class="uk-card  uk-margin-small uk-border-rounded  uk-padding-remove uk-background-secondary-2 " itemtype="https://schema.org/ImageObject" >
	<figure class="thumbnail uk-card-media-top uk-border-rounded uk-inline-clip uk-transition-toggle " itemprop="image"><img src="<?php echo $uploadImage; ?>" alt="<?php echo $titleText; ?>" width="400" height="400" class="uk-transition-scale-up uk-transition-opaque uk-border-rounded" itemprop="url" />
	<div class="uk-position-medium uk-position-bottom-left"><img src="templates/kgf/images/lznak-kgf.svg" alt="Второй международный Форум KGF Oil&Gas"  style="height: 120px;width:auto;"></div>
	...
	<div class="uk-card-body uk-border-rounded  uk-background-secondary-2 uk-card-small">
		<div class="uk-card-title uk-text-center" itemscope="itemscope" ><a href="#<?php echo $moduleLink; ?>" class="uk-text-primary uk-button uk-button-text3 " uk-toggle=""><?php echo $titleText; ?></a>
			<div id="<?php echo $moduleLink; ?>" uk-modal="">
				<div class="uk-modal-dialog">
					...
					<div class="uk-modal-footer uk-text-right">
						<button type="button" class="uk-button uk-button-primary uk-modal-close">Закрыть</button>
					</div>
				</div>
			</div>
		</div>
