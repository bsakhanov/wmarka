...
<div class="uk-card  uk-margin-small uk-border-rounded  uk-padding-remove uk-background-secondary-2 " itemtype="https://schema.org/ImageObject" >
	...
	<div class="uk-position-medium uk-position-bottom-left"><img src="templates/astana/images/lznak-d.svg" alt="<?= JText::_('MOD_PROMO_ALT') ?>"  style="height: 120px;width:auto;"></div>
