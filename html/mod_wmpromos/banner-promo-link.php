...
<li>
<div class="uk-card  uk-width-medium uk-margin-small uk-border-rounded  uk-padding-remove uk-background-secondary-2 box-shadow-kvadro"  itemscope="itemscope" itemtype="https://schema.org/ImageObject" >
	<a href="<?php echo $moduleLink; ?>" target="_<?php echo $moduleTarget; ?>"><figure class="thumbnail uk-card-media-top uk-border-rounded uk-inline-clip uk-transition-toggle "  itemprop="image" ><img src="<?php echo $uploadImage; ?>" alt="<?php echo $titleText; ?>" width="320" height="180" class="uk-transition-scale-up uk-transition-opaque uk-border-rounded" itemprop="url" />
	...
	<div class="uk-card-body uk-border-rounded  uk-background-secondary-2 uk-card-small">
		<div class="uk-card-title uk-text-center" ><a href="<?php echo $moduleLink; ?>" class="uk-text-primary uk-button uk-button-text3 uk-text-truncate" itemprop="name" title="<?php echo $titleText; ?>" uk-tooltip="pos: bottom"><?php echo $titleText; ?></a>
		</div>
