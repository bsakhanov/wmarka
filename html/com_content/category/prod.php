...
<div class="com-content-category-blog blog" itemscope itemtype="https://schema.org/Blog">
    ...
    <?php if (!empty($this->intro_items)) { ?>
        ...
        <div class="uk-child-width-1-<?php echo (int)$this->params->get('num_columns', 1); ?>@m blog-items <?php echo $blogClass; ?> uk-grid-small uk-flex-center uk-text-center"  uk-grid uk-height-match="target: > div > .uk-card">
