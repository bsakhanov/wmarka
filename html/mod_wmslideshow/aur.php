...
JLoader::register('JUImage',  JPATH_LIBRARIES . '/juimage/JUImage.php');
                    $juImg = new JUImage();	
					$thumb1 = $juImg->render($uploadImage1, [
	'w'     	=> '1350',
	'h'     	=> '759',
	'q'         => '70',
	'zc'        => 'C',
	...
	'cache'     => 'img'
					...
					$thumb2 = $juImg->render($uploadImage2, [
	'w'     	=> '1350',
	'h'     	=> '759',
	'q'         => '70',
	'zc'        => 'C',
	...
	'cache'     => 'img'
					...
					$thumb3 = $juImg->render($uploadImage3, [
	'w'     	=> '1350',
	'h'     	=> '759',
	'q'         => '70',
	'zc'        => 'C',
	...
	'cache'     => 'img'
					...
					$thumb4 = $juImg->render($uploadImage4, [
	'w'     	=> '1350',
	'h'     	=> '759',
	'q'         => '70',
	'zc'        => 'C',
	...
	'cache'     => 'img'
					...
					$uptumb1 = $juImg->render($uploadImage1tumb, [
	'w'     	=> '200',
	'h'     	=> '112',
	'q'         => '55',
	'zc'        => 'C',
	...
	'cache'     => 'img'
					...
					$uptumb2 = $juImg->render($uploadImage2tumb, [
	'w'     	=> '200',
	'h'     	=> '112',
	'q'         => '55',
	'zc'        => 'C',
	...
	'cache'     => 'img'
					...
					$uptumb3 = $juImg->render($uploadImage3tumb, [
	'w'     	=> '200',
	'h'     	=> '112',
	'q'         => '55',
	'zc'        => 'C',
	...
	'cache'     => 'img'
					...
					$uptumb4 = $juImg->render($uploadImage4tumb, [
	'w'     	=> '200',
	'h'     	=> '112',
	'q'         => '55',
	'zc'        => 'C',
			...
			<div class="uk-margin uk-text-left@s uk-text-center uk-slideshow" uk-slideshow="minHeight: 500; ratio: 16:7; animation: pull; velocity: 1.4; autoplay: 1;finite: true">
				<div class="uk-position-relative">
					<ul class="uk-slideshow-items uk-light">
						<li class="uk-background-secondary <?php echo $slideBgColor1; ?> uk-active uk-transition-active"  itemscope="itemscope" itemtype="https://schema.org/ImageObject" style="transform: translateX(0px); z-index: -1;">
							<div class="uk-position-cover uk-brightness" uk-slideshow-parallax="scale: 1,1.2,1.2">
							<picture> 
                                     <source  srcset="<?php echo $thumb1->webp; ?>" type="image/webp" >
                                    <img class="opacity-<?php echo $slideBgOpacity1; ?>" itemprop="image"  uk-cover src="<?php echo $thumb1->img; ?>" alt="<?php echo $titleText1; ?>" uk-img="target: !.uk-slideshow-items" />
							</picture>
							</div>
						...
						<li class="uk-background-secondary <?php echo $slideBgColor2; ?>"  itemscope="itemscope" itemtype="https://schema.org/ImageObject">
							<div class="uk-position-cover uk-brightness" uk-slideshow-parallax="scale: 1,1.2,1.2">
							<picture> 
                                    <source  srcset="<?php echo $thumb2->webp; ?>" type="image/webp" >
                                    <img class="opacity-<?php echo $slideBgOpacity2; ?>" itemprop="image"  uk-cover src="<?php echo $thumb2->img; ?>" alt="<?php echo $titleText2; ?>" uk-img="target: !.uk-slideshow-items" />
							</picture>
							</div>
							<div class="uk-position-cover" uk-slideshow-parallax="opacity: 0.2,0,0; backgroundColor: #000,#000"></div>
							<div class="uk-position-cover uk-flex uk-flex-left uk-flex-middle uk-container uk-section" itemscope="itemscope" itemtype="http://schema.org/Service" >
						...
						<li class="uk-background-secondary <?php echo $slideBgColor3; ?>"  itemscope="itemscope" itemtype="https://schema.org/ImageObject">
							<div class="uk-position-cover uk-brightness" uk-slideshow-parallax="scale: 1,1.2,1.2">
							<picture> 
                                    <source  srcset="<?php echo $thumb3->webp; ?>" type="image/webp" >
                                    <img class="opacity-<?php echo $slideBgOpacity3; ?>" itemprop="image"  uk-cover src="<?php echo $thumb3->img; ?>" alt="<?php echo $titleText3; ?>" uk-img="target: !.uk-slideshow-items" />
							</picture>
							</div>
							<div class="uk-position-cover" uk-slideshow-parallax="opacity: 0.2,0,0; backgroundColor: #000,#000"></div>
							<div class="uk-position-cover uk-flex uk-flex-left uk-flex-middle uk-container uk-section" itemscope="itemscope" itemtype="http://schema.org/Service" >
						...
						<li class="uk-background-secondary <?php echo $slideBgColor4; ?>"  itemscope="itemscope" itemtype="https://schema.org/ImageObject">
							<div class="uk-position-cover uk-brightness" uk-slideshow-parallax="scale: 1,1.2,1.2">
							<picture> 
                                    <source  srcset="<?php echo $thumb4->webp; ?>" type="image/webp" >
                                    <img class="opacity-<?php echo $slideBgOpacity4; ?>" itemprop="image"  uk-cover src="<?php echo $thumb4->img; ?>" alt="<?php echo $titleText4; ?>" uk-img="target: !.uk-slideshow-items" />
							</picture>
							</div>
							<div class="uk-position-cover" uk-slideshow-parallax="opacity: 0.2,0,0; backgroundColor: #000,#000"></div>
							<div class="uk-position-cover uk-flex uk-flex-left uk-flex-middle uk-container uk-section" itemscope="itemscope" itemtype="http://schema.org/Service" >
								<div class="el-overlay uk-panel uk-width-xlarge">
									<div class="uk-text-uppercase uk-text-bold uk-margin uk-h6 uk-margin-remove-adjacent"  itemprop="disambiguatingDescription" uk-slideshow-parallax="y: 70,0,-100;"><?php echo $paragraphText4; ?> </div>
									<h1 class="el-title uk-margin uk-heading-primary uk-heading-line" itemprop="name" uk-slideshow-parallax="x: 320,0,-250;"><span><?php echo $titleText4; ?></span></h1>
									<p><a class="uk-button uk-button-primary uk-border-rounded  uk-text-bold uk-button-large" href="<?php echo $moduleLink4doc; ?>" target="_<?php echo $moduleTarget; ?> " uk-slideshow-parallax="y: -60,0,190;"><?= JText::_('MOD_PROMO_MORE') ?></a></p>
								</div>
							</div>
							<div  class="uk-position-large uk-position-top-right <?php echo $titleColor4; ?> uk-tablet-hidden uk-mobile-hidden"  >
					...
					<div class="uk-position-bottom-center uk-position-large uk-visible@s">
						<ul class="el-nav uk-thumbnav uk-flex-center" uk-margin>
							<li class="uk-active uk-first-column" uk-slideshow-item="0">
								<a class="uk-border-rounded " href="#">
								<picture> 
                                    <source srcset="<?php echo $uptumb1->webp; ?>" type="image/webp" width="200" height="112" >
								<img src="<?php echo $uptumb1->img; ?>" alt="<?php echo $titleText1; ?>" itemprop="thumbnailUrl" />
								</picture>
								</a>
							</li>
							<li uk-slideshow-item="1">
								<a class=" uk-border-rounded " href="#">
								<picture> 
                                    <source srcset="<?php echo $uptumb2->webp; ?>" type="image/webp" width="200" height="112" >
								<img src="<?php echo $uptumb2->img; ?>" alt="<?php echo $titleText2; ?>" itemprop="thumbnailUrl" />
								</picture>
								</a>
							</li>
							<li uk-slideshow-item="2">
								<a class="uk-border-rounded " href="#">
								<picture> 
                                    <source srcset="<?php echo $uptumb3->webp; ?>" type="image/webp" width="200" height="112" >
								<img src="<?php echo $uptumb3->img; ?>" alt="<?php echo $titleText3; ?>" itemprop="thumbnailUrl" />
								</picture>
								</a>
							</li>
							<li uk-slideshow-item="3">
								<a class="uk-border-rounded " href="#">
								<picture> 
                                    <source srcset="<?php echo $uptumb4->webp; ?>" type="image/webp" width="200" height="112" >
								<img src="<?php echo $uptumb4->img; ?>" alt="<?php echo $titleText4; ?>" itemprop="thumbnailUrl" />
								</picture>
								</a>
							</li>							
						</ul>
