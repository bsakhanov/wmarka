...
?>
<div class=" uk-position-relative" uk-slideshow="ratio: 7:2; animation: push; autoplay: true" >
	<ul class="uk-slideshow-items">
		<li class=" uk-background-primary <?php echo $slideBgColor1; ?> slider-back-01   " itemscope="itemscope" itemtype="https://schema.org/ImageObject" ><img class="opacity-<?php echo $slideBgOpacity1; ?>" itemprop="image" src="<?php echo $uploadImage1; ?>" alt="<?php echo $titleText1; ?>"  uk-cover  />
			<a  class="uk-position-large uk-position-top-right uk-text-left" itemscope="itemscope" itemtype="http://schema.org/Service" href="<?php echo $moduleLink1; ?>" target="_<?php echo $moduleTarget; ?> " >
			...
			<div  class="uk-position-large uk-position-top-left uk-text-left <?php echo $titleColor1; ?> uk-tablet-hidden uk-mobile-hidden"  >
				<span uk-icon="icon: <?php echo $titleIcon1; ?>; ratio: 16"></span>
			</div>			
		</li>
		<li class=" uk-background-primary <?php echo $slideBgColor2; ?> slider-back-01" itemscope="itemscope" itemtype="https://schema.org/ImageObject"><img class="opacity-<?php echo $slideBgOpacity2; ?>" itemprop="image" src="<?php echo $uploadImage2; ?>" alt="<?php echo $titleText2; ?>"  uk-cover  />
			<a  class="uk-position-large uk-position-top-right uk-text-left" itemscope="itemscope" itemtype="http://schema.org/Service" href="<?php echo $moduleLink2; ?>" target="_<?php echo $moduleTarget; ?> " >
			...
			<div  class="uk-position-large uk-position-top-left uk-text-left <?php echo $titleColor2; ?> uk-tablet-hidden uk-mobile-hidden"  >
				<span uk-icon="icon: <?php echo $titleIcon2; ?>; ratio: 16"></span>
			</div>				
		</li>
		<li class=" uk-background-primary <?php echo $slideBgColor3; ?> slider-back-01" itemscope="itemscope" itemtype="https://schema.org/ImageObject"><img class="opacity-<?php echo $slideBgOpacity3; ?>" itemprop="image" src="<?php echo $uploadImage3; ?>" alt="<?php echo $titleText3; ?>"  uk-cover  />
			<a  class="uk-position-large uk-position-top-right uk-text-left" itemscope="itemscope" itemtype="http://schema.org/Service" href="<?php echo $moduleLink3; ?>" target="_<?php echo $moduleTarget; ?> " >
			...
			<div  class="uk-position-large uk-position-top-left uk-text-left <?php echo $titleColor3; ?> uk-tablet-hidden uk-mobile-hidden"  >
				<span uk-icon="icon: <?php echo $titleIcon3; ?>; ratio: 16"></span>
			</div>				
		</li>
		<li class=" uk-background-primary <?php echo $slideBgColor4; ?> slider-back-01" itemscope="itemscope" itemtype="https://schema.org/ImageObject"><img class="opacity-<?php echo $slideBgOpacity4; ?> " itemprop="image" src="<?php echo $uploadImage4; ?>" alt="<?php echo $titleText4; ?>"  uk-cover  />
			<a  class="uk-position-large uk-position-top-right uk-text-left" itemscope="itemscope" itemtype="http://schema.org/Service" href="<?php echo $moduleLink4; ?>" target="_<?php echo $moduleTarget; ?> " >
			...
			<div  class="uk-position-large uk-position-top-left uk-text-left <?php echo $titleColor4; ?> uk-tablet-hidden uk-mobile-hidden"  >
				<span uk-icon="icon: <?php echo $titleIcon4; ?>; ratio: 16"></span>
			</div>				
		</li>
