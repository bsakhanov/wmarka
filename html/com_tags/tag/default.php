...
<div class="com-tags-tag tag-category">
    ...
    <?php if ($this->params->get('show_tag_title', 1)) : ?>
        <<?php echo $htag; ?>>
            <div class="uk-h2 uk-text-uppercase">#<?php echo HTMLHelper::_('content.prepare', $this->tags_title, '', 'com_tag.tag'); ?></div>
        </<?php echo $htag; ?>>
    <?php endif; ?>
...
?>			
                <img src="<?php echo $thumb->webp; ?>" type="image/webp" width="2000" height="720" alt="<?php echo $this->tags_title; ?> "  itemprop="thumbnailUrl"/>
            <?php endif; ?>
