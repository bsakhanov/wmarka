...
<div class="mod_uk_grid<?php echo $grid_class, $classes; ?> uk-container uk-margin-top uk-flex uk-flex-center " data-uk-grid<?php echo $grid_params, $hm_param; ?>>
    <?php
